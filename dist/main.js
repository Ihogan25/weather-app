...
const card = (() => {
    const mainCard = (name, country, tempature) => {
    ...
    const sideCard = (dataOne, dataTwo, dataThree, dataFour) => {
        const card = document.createElement('div');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const weatherApiKey = 'da19c37c32dd76a76e6a97a58c30d21a';
const fetchApi = (() => {
...
exports.domData = {
    ...
    sideCardOne: document.getElementById('side-card-one'),
...
const storage = (() => {
    const clearData = () => {
        ...
        const sideCardTwo = _1.domData.sideCardTwo;
        _1.domData.newLocationInput.value = '';
...
/***/ "./src/imgs/noaa-99F4mC79j1I-unsplash (1).jpg":
/*!****************************************************!*\
  !*** ./src/imgs/noaa-99F4mC79j1I-unsplash (1).jpg ***!
  \****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "a689a767a94f1b43ae14.jpg";
